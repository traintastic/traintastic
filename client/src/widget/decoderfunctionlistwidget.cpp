...
DecoderFunctionListWidget::DecoderFunctionListWidget(const ObjectPtr& object, QWidget* parent) :
...
void DecoderFunctionListWidget::add()
{
  /*m_object->connection()->createObject("hardware.decoder_function", "",
