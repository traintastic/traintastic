...
RouteWidget::RouteWidget(ObjectPtr object, QWidget* parent)
  : QWidget(parent)
  ...
  , m_tabs{new QTabWidget(this)}
{
  ...
  {
    connect(name, &AbstractProperty::valueChangedString, this, &RouteWidget::setWindowTitle);
    setWindowTitle(name->toString());
  }

  // Route entries:
  m_tabs->addTab(new RouteEntriesWidget(m_object, this), "Route");
