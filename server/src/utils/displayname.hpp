...
namespace DisplayName
{
  ...
  namespace Vehicle
  {
    namespace Rail
    {
      ...
      constexpr std::string_view maxAccelerationRate = "vehicle.rail:max_acceleration_rate";
      constexpr std::string_view maxBrakingRate = "vehicle.rail:max_braking_rate";
    }
  }
  namespace World
  {
