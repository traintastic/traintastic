/**
 * server/src/board/nx/nxmanager.hpp
 *
...
#ifndef TRAINTASTIC_SERVER_BOARD_NX_NXMANAGER_HPP
#define TRAINTASTIC_SERVER_BOARD_NX_NXMANAGER_HPP
...
class NXManager : public SubObject
{
  CLASS_ID("nx_manager")
