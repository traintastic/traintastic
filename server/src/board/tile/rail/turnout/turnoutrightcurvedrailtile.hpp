...
class TurnoutRightCurvedRailTile : public TurnoutRightRailTile
{
  CLASS_ID("board_tile.rail.turnout_right_curved")
  CREATE(TurnoutRightCurvedRailTile)

  public:
    TurnoutRightCurvedRailTile(const std::weak_ptr<World>& world, std::string_view _id);
};
