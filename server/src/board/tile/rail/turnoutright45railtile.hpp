...
class TurnoutRight45RailTile : public TurnoutRightRailTile
{
  CLASS_ID("board_tile.rail.turnout_right_45")
  CREATE(TurnoutRight45RailTile)

  public:
    TurnoutRight45RailTile(const std::weak_ptr<World>& world, std::string_view _id);
};
