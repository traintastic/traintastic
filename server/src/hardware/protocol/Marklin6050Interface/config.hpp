...
#ifndef TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLIN6050INTERFACE_CONFIG_HPP
#define TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLIN6050INTERFACE_CONFIG_HPP
