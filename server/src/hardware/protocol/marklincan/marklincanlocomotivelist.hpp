...
#ifndef TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLINCAN_MARKLINCANLOCOMOTIVELIST_HPP
#define TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLINCAN_MARKLINCANLOCOMOTIVELIST_HPP
