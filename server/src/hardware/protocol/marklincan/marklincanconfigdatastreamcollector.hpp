...
#ifndef TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLINCAN_MARKLINCANCONFIGDATASTREAMCOLLECTOR_HPP
#define TRAINTASTIC_SERVER_HARDWARE_PROTOCOL_MARKLINCAN_MARKLINCANCONFIGDATASTREAMCOLLECTOR_HPP

#include <cstddef>
#include <vector>
#include "message/marklincanconfigdata.hpp"
