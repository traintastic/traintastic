/**
 * server/src/hardware/inpu/outputlist.hpp
 *
...
#ifndef TRAINTASTIC_SERVER_HARDWARE_OUTPUT_OUTPUTLIST_HPP
#define TRAINTASTIC_SERVER_HARDWARE_OUTPUT_OUTPUTLIST_HPP
