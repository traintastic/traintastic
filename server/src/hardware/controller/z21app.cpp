/**
 * server/src/hardware/controller/z21app.cpp
 *
...
Z21App::Z21App(const std::weak_ptr<World> world, std::string_view _id) :
...
bool Z21App::setActive(bool& value)
{
...
void Z21App::emergencyStopChanged(bool value)
{
  if(value)
  {
...
void Z21App::trackPowerChanged(bool value)
{
  if(value)
  {
    const z21_lan_x_bc_track_power_on message;
...
void Z21App::decoderChanged(const Hardware::Decoder& decoder, Hardware::DecoderChangeFlags, uint32_t)
{
...
void Z21App::sendTo(const z21_lan_header& msg, const boost::asio::ip::udp::endpoint& endpoint)
{
...
void Z21App::sendTo(const Protocol::Z21::Message& message, const boost::asio::ip::udp::endpoint& endpoint)
{
  // TODO: add to queue, send async
...
void Z21App::broadcastLocoInfo(const Hardware::Decoder& decoder)
{
