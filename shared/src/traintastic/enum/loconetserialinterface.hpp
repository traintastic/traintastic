/**
 * shared/src/enum/loconetserialinterface.hpp
 *
...
#ifndef TRAINTASTIC_SHARED_TRAINTASTIC_ENUM_LOCONETSERIALINTERFACE_HPP
#define TRAINTASTIC_SHARED_TRAINTASTIC_ENUM_LOCONETSERIALINTERFACE_HPP
